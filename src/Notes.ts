...
export const FeelNoPain = new Note(
  `FeelNoPain`,
  `FNP is the category of abilities where just before damage is actually resolved, you roll a die for each successful hit (strike). On a roll at or above the threshold (4+, 5+, or 6+), that hit's damage is reduced by 1. Even MWx damage can be prevented via FNP.`,
);
